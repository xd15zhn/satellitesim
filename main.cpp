...
int main(void) {
    ...
    simSates[1].Set_initRV(Vector3{15, 0, 5}, Vector3{0, 21, 0});
    simSates[2].Set_initRV(Vector3{15, 1, -5}, Vector3{0, 20, 0});
    ...
    while (!WindowShouldClose()) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            ShuttlePosition[i].x = vec3d.x;
            ShuttlePosition[i].y = vec3d.z;
            ShuttlePosition[i].z = vec3d.y;
